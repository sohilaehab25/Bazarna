...
import { adminMatchGuard } from './admin/core/guards/admin-match.guard';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'edit-profile',
        loadComponent: () => import('./features/edit-profile/edit-profile.component').then((m) => m.EditProfileComponent),
        canActivate: [authGuard],
      },
      { path: 'login', loadComponent: () => import('./features/login/login.component').then((m) => m.LoginComponent) },
      {
        path: 'confirm-signup',
        loadComponent: () => import('./features/confirm-signup/confirm-signup.component').then((m) => m.ConfirmSignupComponent),
      },
      {
